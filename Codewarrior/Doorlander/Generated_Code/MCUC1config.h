...
/* identification of CPU/core used. __CORTEX_M is defined in CMSIS-Core.
   Otherwise CPU Family is set automatically by Processor Expert: detected: ColdFireV1 (supported: "Kinetis", "S32K", "HCS08")
*/
#define MCUC1_CONFIG_CPU_IS_ARM_CORTEX_M    (0 || defined(__CORTEX_M))
