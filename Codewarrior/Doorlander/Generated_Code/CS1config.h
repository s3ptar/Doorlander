...
/* select ONE of the following implementation methods: */
  ...
  #define CS1_CONFIG_USE_CUSTOM_CRITICAL_SECTION            0 /* 1: Custom implementation (supported for GNU and ARM!); 0: don't use custom implementation */
#endif

#ifndef CS1_CONFIG_USE_PEX_DEFAULT
  #define CS1_CONFIG_USE_PEX_DEFAULT                        1 /* 1: use Processor Expert default; 0: use alternative implementation */
#endif
